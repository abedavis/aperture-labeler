...
import { ATriangleMeshModel} from "../anigraph/scene/nodes";
...
export class IBRSceneModelView extends ASceneNodeView<IBRSceneModel> {
  controller!: ASceneNodeController<IBRSceneModel>;
  public element!: ATriangleMeshGraphic;
  public guiGroup!: ARenderGroup;
  public targetSphereElement!: ATriangleMeshGraphic;
  public _guiCameraFrustaGroup!: ARenderGroup;
